...
public class TicTacToe extends Application {
    //indicate which player has a turn, initially it is the X
    ...
    public class Cell extends Pane{
        ...
        private void handleMouseClick(){
            //if cell is not empty and the game is not over
            if(token == ' ' && whoseTurn != ' '){
                setToken(whoseTurn); // Set the token in the cell
